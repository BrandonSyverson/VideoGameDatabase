//creates a user in the database when given a username, password, and favorite game
...
public class createUser {
    ...
    static final String password="bs2719"; // please enter your own password
	    ...
	    public static void main(String args[]) {
	    	...
	    	//String sqlQuery ="INSERT INTO User (username, password, favoriteGame) VALUES ('testUser', 'testPassword', 'testGame');";
